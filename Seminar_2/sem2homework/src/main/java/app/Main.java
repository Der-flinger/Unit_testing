...
// методы. При создании объекта ""Motorcycle"", число колес устанавливается в 2, 
// а скорость в 0. В методе ""testDrive()"" скорость устанавливается на 75, а в 
// методе ""park()"" - обратно в 0.
public class Main {
    public static void main(String[] args) {
        Car car = new Car("Dsafsd", "dsad", 2001);
        System.out.println(Vehicle.class);
        System.out.println(car.getClass().getDeclaringClass());
    }
}